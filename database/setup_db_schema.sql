...
DROP TABLE IF EXISTS `approval_request_messaging`;
...
DROP TABLE IF EXISTS `expense_variance_note`;
...
DROP TABLE IF EXISTS `overpay_charge_detail`;
...
(33,	'manage_invoice_require_approval',	'false'),
(34,	'student_payment_spread_mode',	'order'),
(37,	'show_unpaid_invoice_when_mass_creating_invoices',	'true');
