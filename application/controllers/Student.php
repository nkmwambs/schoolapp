...
class Student extends CI_Controller {
	...
	function all_students() {
		...
		$this->db->select(array('student_id','student.name as student_name','class.name as class_name','address','roll',
		'sex','student.class_id as class_id'));
		$this->db->join('class','class.class_id=student.class_id');
		//$this->db->join('parent','parent.parent_id=student.parent_id');
		$page_data['students'] = $this->db->get_where('student',array('active'=>1))->result_array();
