<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <!-- DASHBOARD -->
        <li class="<?php if ($page_name == 'dashboard') echo 'active'; ?> dashboard">
        ...
        ?> student">
            ...
            <ul>
                <!-- STUDENT ADMISSION -->
                <li class="<?php if ($page_name == 'student_add') echo 'active'; ?> student_admission">
                ...
                <li class="<?php if ($page_name == 'student_bulk_add') echo 'active'; ?> student_admission">
                ...
                <!-- STUDENT INFORMATION -->
                <li class="<?php if ($page_name == 'student_information' || $page_name == 'student_marksheet') echo 'opened active'; ?> all_student_information">
                    <a href="#">
        ...
        <!-- TEACHER -->
        <li class="<?php if ($page_name == 'teacher') echo 'active'; ?> teacher show_teacher">
        ...
        ?> parent">
            ...
            <ul>
                <li class="<?php if ($page_name == 'parent') echo 'active'; ?> view_parents">
                    <a href="<?php echo base_url(); ?>index.php?parents/parent">
                        <span><i class="fa fa-user-md"></i> <?php echo get_phrase('view_parent'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'parent_activity') echo 'active'; ?> parents_activity">
        ...
        <!-- SUBJECT -->
        <li class="<?php if ($page_name == 'subject') echo 'opened active'; ?> subject show_subject">
            <a href="#">
