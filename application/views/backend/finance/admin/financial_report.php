...
<div class="row">
	...
	<hr/>
		<?php echo form_open(base_url() . 'index.php?finance/financial_report/scroll' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
	...
	<div class="col-sm-6">
		...
		<caption><?=get_phrase('revenue_report_for')." ".date('F Y',strtotime($current_date));?> (Student Income)</caption>
	...
	<div class="col-sm-6">
		<caption><?=get_phrase('revenue_report_for')." ".date('F Y',strtotime($current_date));?> (Other Income)</caption>
		<table class="table table-bordered">
			<thead>
				<tr>
					<th><?=get_phrase('income_category');?></th>
