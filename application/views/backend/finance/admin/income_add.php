...
<script>
	...
	$('#add_row').click(function(){
		...
		$('#tbl_details tbody').append(
										...
										'</td><td><input value="0" type="number" min="0.1" class="form-control" id="qty_'+row+'" name="qty[]" onkeyup="return calculate_cost('+row+');" required="required"/></td>'+
										'<td><input type="text" class="form-control" id="desc_'+row+'" name="desc[]"  required="required"/></td>'+
										'<td><input value="0" type="number" min="0.1" class="form-control" id="unitcost_'+row+'"  name="unitcost[]" onkeyup="return calculate_cost('+row+');"  required="required"/></td>'+
