...
<div class="row">
	<div class="col-xs-12" style="text-align: center;font-weight: bold;font-size: 18pt;">
		<?=get_phrase('month_income');?>: <?=date('F Y',$month_stamp);?>
	</div>
</div>
<p></p>
...
<br />
<div class="row" id="income_placeholder">
	<div class="col-sm-1">
		<a  href="<?=base_url();?>index.php?finance/scroll_income/<?=strtotime('first day of last month',$month_stamp);?>"><i style="font-size: 145pt;" class="fa fa-angle-left"></i></a>
	</div>
...
<script type="text/javascript">
	...
	$("#prev_year, #next_year").click(function(){
			...
			var url = "<?=base_url();?>index.php?finance/income_scroll/<?=strtotime('-1 year');?>";
			if($(this).attr('id')=='next_year'){
				url = "<?=base_url();?>index.php?finance/income_scroll/<?=strtotime('+1 year');?>";
			}
