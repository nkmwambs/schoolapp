...
<div class="row">
	<div class="col-xs-1">
		<a href="<?= base_url(); ?>index.php?finance/paid_invoices/<?= $year - 1; ?>"><i style="font-size: 145pt;" class="fa fa-angle-left"></i></a>
	</div>
      ...
      <div class="col-xs-12">
            <div class="panel panel-default panel-shadow" data-collapsed="0">
                <div class="panel-heading">
                    <div class="panel-title"><?php echo get_phrase('paid_invoices');?></div>
                  </div>
  ...
  <div class="col-xs-1">
    <a href="<?= base_url(); ?>index.php?finance/paid_invoices/<?= $year + 1; ?>"><i style="font-size: 145pt;" class="fa fa-angle-right"></i></a>
  </div>
</div>
