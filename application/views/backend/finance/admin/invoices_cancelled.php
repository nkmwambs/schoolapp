                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                          ...
                          <?php if ($row['carry_forward_to'] > 0) { ?>
                            <li>
                              <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/modal_view_invoice/<?php echo $row['carry_forward_to']; ?>');">
                                <i class="entypo-credit-card"></i>
                                <?php echo get_phrase('view_carried_forward_invoice'); ?>
                              </a>
                            </li>
