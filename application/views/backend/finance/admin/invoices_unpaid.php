                        ...
                        <table class="table table-striped datatable example">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <div><?php echo get_phrase('fee_structure_total'); ?></div>
                                    </th>
                                    <th>
                                        <div><?php echo get_phrase('payable_amount'); ?></div>
                                    </th>
                                    <th>
                                        <div><?php echo get_phrase('actual_paid'); ?></div>
                                    </th>
                                    <th>
                                    ...
                                    <th>
                                        <div><?php echo get_phrase('approval_request_type'); ?></div>
                                    </th>
                                    <th>
                                        <div><?php echo get_phrase('approval_status'); ?></div>
                                    </th>
                                    <th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        $fee_structure_amount_obj = $this->db->get_where(
                                            'fees_structure',
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                    ...
                                                    <?php if($row['carry_forward_from'] > 0){?>
                                                    <li>
                                                        <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/modal_view_invoice/<?php echo $row['carry_forward_from']; ?>');">
                                                            <i class="entypo-credit-card"></i>
                                                            <?php echo get_phrase('view_previous_invoice'); ?>
                                                        </a>
                                                    </li>
