            ...
            <div class="panel-body">
               ...
               <div class="col-md-6">
                   <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                            $total_marks = 0;
                            $total_grade_point = 0;
                            $subjects_object = $this->db->get_where('subject' , array('class_id' => $class_id));
                            $subjects = $subjects_object->result_array();

                            if($subjects_object->num_rows() > 0){
                            $row4['mark_obtained'] = 0;$row4['comment'] = "";
                   ...
                   <?php echo get_phrase('average_grade_point');?> :
                    ...
                    <br> <br>
                    <a href="<?php echo base_url();?>index.php?exam/student_marksheet_print_view/<?php echo $student_id;?>/<?php echo $row2['exam_id'];?>"
