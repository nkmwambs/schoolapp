<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        ?> <?=get_access_class('student','admin');?>">
            ...
            <ul>
                <!-- STUDENT ADMISSION -->
                <li class="<?php if ($page_name == 'student_add') echo 'active'; ?> <?=get_access_class('student_admission','admin','student');?>">
                ...
                <li class="<?php if ($page_name == 'student_bulk_add') echo 'active'; ?> <?=get_access_class('bulk_student_admission','admin','student');?>">
                ...
                <li class="<?php if ($page_name == 'student_information' || $page_name == 'student_marksheet') echo 'opened active'; ?> <?=get_access_class('all_student_information','admin','student');?> <?=get_access_class('student','admin');?>">
                    ...
                    <ul>
						...
						//if($this->session->login_type == 'teacher') 
							//$classes = $this->db->order_by("name_numeric","asc")->get_where('class',array("teacher_id"=>$this->session->login_user_id))->result_array();						
        ...
        <!-- TEACHER -->
        <li class="<?php if ($page_name == 'teacher') echo 'active'; ?>  <?=get_access_class('teacher','admin');?>">
        ...
        ?> <?=get_access_class('parent','admin');?>">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'parent_activity') echo 'active'; ?> <?=get_access_class('parents_activity','admin','parent');?>">
        ...
        if ($page_name == 'class' ||
                $page_name == 'section')
            echo 'opened active';
        ?> <?=get_access_class('classes','admin');?>">
            <a href="#">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'section') echo 'active'; ?> <?=get_access_class('manage_sections','admin','classes');?>">
        ...
        <!-- SUBJECT -->
        <li class="<?php if ($page_name == 'subject') echo 'opened active'; ?> <?=get_access_class('subject','admin');?>">
            <a href="#">
        ...
        <!-- CLASS ROUTINE -->
        <li class="<?php if ($page_name == 'class_routine') echo 'active'; ?> <?=get_access_class('class_routine','admin');?>">
        ...
        <!-- DAILY ATTENDANCE -->
        <li class="<?php if ($page_name == 'manage_attendance') echo 'active'; ?> <?=get_access_class('manage_attendance','admin');?>">
                ...
                $page_name == 'marks' ||
                    $page_name == 'exam_marks_sms' ||
                        $page_name == 'tabulation_sheet')
                            echo 'opened active';
        ?> <?=get_access_class('examination','admin');?>">
            <a href="#">
                <i class="entypo-graduation-cap"></i>
                <span><?php echo get_phrase('exam'); ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'exam') echo 'active'; ?> <?=get_access_class('examination_list','admin','examination');?>">
                    <a href="<?php echo base_url(); ?>index.php?exam/exam">
                        <span><i class="fa fa-bell"></i> <?php echo get_phrase('exam_list'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'grade') echo 'active'; ?> <?=get_access_class('examination_grades','admin','examination');?>">
                    <a href="<?php echo base_url(); ?>index.php?exam/grade">
                        <span><i class="fa fa-archive"></i> <?php echo get_phrase('exam_grades'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'marks') echo 'active'; ?> <?=get_access_class('manage_marks','admin','examination');?>">
                    <a href="<?php echo base_url(); ?>index.php?exam/marks">
                        <span><i class="fa fa-bullseye"></i> <?php echo get_phrase('manage_marks'); ?></span>
                    </a>
                </li>
                <li class="<?php if ($page_name == 'exam_marks_sms') echo 'active'; ?> <?=get_access_class('send_marks_by_sms','admin','examination');?>">
            ...
            <ul>
                ...
                <li class="<?php if (
                    ...
                    <a href="#">
                     ...
                     <ul>
                        <li class="<?php if ($page_name == 'fund_balance_report') echo 'active'; ?> <?=get_access_class('fund_balance_report','admin','accounting');?>">
                        ...
                        <li class="<?php if ($page_name == 'expense_variance_report') echo 'active'; ?> <?=get_access_class('expense_variance_report','admin','accounting');?>">
        ...
        <!--New Finance Feature - The End -->

        <!-- LIBRARY -->
        <li class="<?php if ($page_name == 'book') echo 'active'; ?> <?=get_access_class('library','admin');?>">
        ...
        <!-- TRANSPORT -->
        <li class="<?php if ($page_name == 'transport') echo 'active'; ?> <?=get_access_class('transport','admin');?>">
        ...
        <!-- DORMITORY -->
        <li class="<?php if ($page_name == 'dormitory') echo 'active'; ?> <?=get_access_class('dormitory','admin');?>">
        ...
        <!-- NOTICEBOARD -->
        <li class="<?php if ($page_name == 'noticeboard') echo 'active'; ?> <?=get_access_class('noticeboard','admin');?>">
        ...
        <!-- MESSAGE -->
        <li class="<?php if ($page_name == 'message') echo 'active'; ?> <?=get_access_class('messages','admin');?>">
        ...
        if ($page_name == 'system_settings' ||
                $page_name == 'manage_language' ||
					...
					$page_name == 'user_profiles')
                        echo 'opened active';
        ?> <?=get_access_class('settings','admin');?>">
            <a href="#">
                <i class="entypo-lifebuoy"></i>
                <span><?php echo get_phrase('settings'); ?></span>
            </a>
            <ul>
                <li class="<?php if ($page_name == 'system_settings') echo 'active'; ?> <?=get_access_class('general_settings','admin','settings');?>">
                ...
                <li class="<?php if ($page_name == 'sms_settings') echo 'active'; ?> <?=get_access_class('sms_settings','admin','settings');?>">
                ...
                <li class="<?php if ($page_name == 'manage_language') echo 'active'; ?> <?=get_access_class('language_settings','admin','settings');?>">
                 ...
                 <li class="<?php if ($page_name == 'school_settings') echo 'active'; ?> <?=get_access_class('school_settings','admin','settings');?>">
                ...
                <li class="<?php if ($page_name == 'user_profiles') echo 'active'; ?> <?=get_access_class('user_profiles','admin','settings');?>">
         ...
         <!-- Admin -->
        <li class="<?php if ($page_name == 'administrator') echo 'active'; ?> <?=get_access_class('administrator','admin');?>">
        ...
        <!-- ACCOUNT -->
        <li class="<?php if ($page_name == 'manage_profile') echo 'active'; ?> <?=get_access_class('manage_accounts','admin');?>">
