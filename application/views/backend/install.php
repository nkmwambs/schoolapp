		...
		<div class="login-content" style="width:100%;">
			...
			<p class="description">
            	<h2 style="color:#cacaca; font-weight:100;">
								<?=$this->db->get_where('settings',array('type'=>'system_name'))->row()->description;?>
              </h2>
           </p>
		...
		<div class="col-md-4">
			<div class="panel panel-primary" style="background-color:rgba(255, 255, 255, 0);border-color: rgba(235, 235, 235, 0.14);">
		    	...
		    	<div class="panel-body">
			    		...
			    		<p><a href="#" style="color:white;">Before running the application, please follow the installation instruction provided in the Developer Manual Documentation.</a></p>
							<p><a href="<?=base_url().'index.php?install/set_up_admin_user'?>" class="btn btn-success">Next</a></p>
