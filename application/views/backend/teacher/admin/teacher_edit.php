	...
	<div class="col-md-12">
		<div class="panel panel-default" data-collapsed="0">
			...
			<div class="panel-body">
                    <?php echo form_open(base_url() . 'index.php?teacher/teacher/do_update/'.$row['teacher_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control unique" data-tablename="teacher" name="phone" value="<?php echo $row['phone'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('email');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control unique" name="email" data-tablename="teacher" value="<?php echo $row['email'];?>"/>
                                </div>
                            </div>
