	...
	<div class="col-xs-12">
		<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<?php
						echo form_open(base_url() . 'index.php?settings/school_settings/add_term/' , array('id'=>'frm_term','class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));
					?>
