<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
                ...
                <li class="<?php if ($page_name == 'student_information' || $page_name == 'student_marksheet') echo 'opened active'; ?> all_student_information">
                    ...
                    <ul>
                        ...
                        foreach ($classes as $row):
                            ?>
                            <li class="<?php if ($page_name == 'student_information' && $page_name == 'student_marksheet' && $class_id == $row['class_id']) echo 'active'; ?> class_<?php echo $row['name_numeric']; ?>_students_information">
        ...
        <!-- TEACHER -->
        <li class="<?php if ($page_name == 'teacher') echo 'active'; ?> teacher">
