	...
	<div class="login-header login-caret">
		...
		<div class="login-content" style="width:100%;">
			...
			<a href="<?php echo base_url();?>" class="logo">
				<img src="uploads/logo.png" height="140" alt="" />
			</a>
			...
			<form method="post" role="form" id="form_login">
				...
				<div class="form-group">
						<div class="col-xs-12 text-center">
							 <span style="font-weight:bold;font-size:16pt;">OR</span>
						</div>
				</div>

				<div id="login_wrapper" style="padding:15px;background-color:white;border-radius:10px;">

						<div class="form-group">
								<div class="col-xs-12">
									<span style="font-weight:bold;font-size:16pt;color:black;"><?=get_phrase('login');?></span>
								</div>
						</div>
